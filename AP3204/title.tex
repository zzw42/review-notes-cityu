...
\textsc{\large {AAP3204}}\\[0.5cm] 						% Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries  \textsf{Waves and Optics} }\\[0.4cm] % Title of your document
%\rightline{{\bfseries \textsf{Version 0.x}} }
\HRule \\[1.5cm]
...
\emph{Instructor:} \\
Ruiqin \textsc{Zhang} (张瑞勤) % Supervisor's Name
\end{flushright}
\end{minipage}\\[2cm]
