...
and the simplest kind of periodic motion is a \emph{simple harmonic motion}\index{simple harmonic motion} 
...
motion with the net exerted by spring as a \emph{linear restoring force}\index{Linear restoring force}
\[\mathbf{F}=-k\mathbf{x},\]
