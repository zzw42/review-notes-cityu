...
% More at: https://liam0205.me/2017/05/17/help-the-url-command-from-hyperref-to-break-at-line-wrapping-point/
...
\usepackage[dvipsnames]{xcolor}  % loaded before ``pgfplots"
...
\usepackage{framed}
  \colorlet{shadecolor}{White!90!Cerulean}
...
\usepackage{mdframed}
  \mdfdefinestyle{exampledefault}{%
    ...
    innerrightmargin         =  10,
    frametitlerule           =  true,
    frametitlerulecolor      =  White!90!Cerulean,
    frametitlebackgroundcolor=  White!50!Cerulean,
...
\rightline{{\bfseries \textsf{Version 1.02.1}} }
\HRule \\[1.5cm]
...
by Jay Devore, 8th Ed., Brooks/Cole Cengage Learning, 2012. }
\\
