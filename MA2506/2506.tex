% finished : chapter1-6 :P 2017/4/18 -WEI 
% v 0.6
...
\usepackage[utf8]{inputenc} %\frontmatter & \mainmatter

% figures are in the folder ~\figures\   (Windows)
\usepackage{graphicx}
\graphicspath {{figures/}}
\usepackage{float} % adjust the picture
...
\usepackage{pgfplots}
% the package run in compatible mode according the log
...
% not quite sure about how this works and I would not change it now - commented by WEI
